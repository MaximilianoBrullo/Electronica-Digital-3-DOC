...
uint16_t *buffer1 = (uint16_t*)SRAM;//puntero al inicio del bloque de memoria
uint16_t *buffer2 = (uint16_t*)(SRAM + 32);//puntero a la mitad del bloque de memoria
uint16_t valorDAC = 0;
